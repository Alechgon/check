...
- **Una hoja por técnico** (ej. `Rodrigo Martínez`) — se crea sola la primera vez que ese técnico cierra un caso. Guarda todo el historial con los **materiales expandidos en columnas** (`Material 1 | Cant 1 | Precio 1 | Subtotal 1 | Material 2 | …`) para que sumes fácil.
